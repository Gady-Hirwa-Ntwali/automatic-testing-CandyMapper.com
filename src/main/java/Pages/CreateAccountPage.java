...
public class CreateAccountPage {
    ...
    public CreateAccountMessagePage clickCreate(){
        driver.findElement(createButton).click();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.visibilityOfElementLocated(returnStirng));
        return new CreateAccountMessagePage(driver);
    }
}
